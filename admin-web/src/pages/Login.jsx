            ...
            <div className="hidden md:flex md:w-[40%] bg-blue-600 relative items-center justify-center p-12 overflow-hidden">
                ...
                <div className="relative z-10 text-center animate-in fade-in slide-in-from-left duration-700">
                    ...
                    <p className="text-blue-100 text-lg font-medium opacity-80 max-w-xs mx-auto leading-relaxed">
                        The most advanced bus ticketing management system for modern transit.
                    </p>
                </div>

                {/* Floating Decorative Elements */}
                <div className="absolute bottom-10 left-10 w-20 h-20 border-4 border-white/10 rounded-full animate-bounce duration-[3000ms]" />
                <div className="absolute top-10 right-10 w-32 h-32 border-4 border-white/5 rounded-[3rem] rotate-12 animate-pulse" />
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative overflow-hidden">
                ...
                <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
                    ...
                    <div className="mb-10 text-left">
                        <h1 className="text-4xl font-extrabold text-slate-800 tracking-tight mb-3">Welcome, <span className="text-blue-600">Admin</span></h1>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between px-1">
                            <label className="flex items-center space-x-2 cursor-pointer group">
                                <input type="checkbox" className="w-4 h-4 rounded border-slate-300 bg-white text-blue-600 focus:ring-offset-0 focus:ring-1 focus:ring-blue-500/50" />
                                <span className="text-sm text-slate-500 group-hover:text-slate-700 transition-colors">Keep me logged in</span>
                            </label>
                    ...
                    <div className="mt-12 text-center pt-8 border-t border-slate-100">
                        <p className="text-slate-500 font-medium">
                            New here?{' '}
                            <Link to="/signup" className="text-blue-600 font-bold hover:text-blue-500 underline decoration-blue-500/30 underline-offset-8 transition-all">
